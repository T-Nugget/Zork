...
namespace Zork
{
    class Program
    {
        ...
        private static void InitializeRoomDescriptions()
        {
            ...
            Rooms[0, 1].Description = "You are facing the north side of a white house. There is no door here, and all the windows are barred."; //South of House
            Rooms[0, 2].Description = "You are in a clearing, with a forest surrounding you on the west and south."; //Canyon View
